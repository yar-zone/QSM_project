...
async def run_test():
    ...
    try:
        ...
        # -> Fill the 'البريد الإلكتروني' field with 'admin@qsm.com', fill the 'كلمة المرور' field with 'password123', then click the 'تسجيل الدخول' button to submit the login form.
