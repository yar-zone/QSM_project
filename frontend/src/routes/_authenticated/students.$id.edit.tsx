...
const schema = z.object({
  ...
  guardian_id: z.string().trim().optional().or(z.literal("")),
  ...
  const onSubmit = async (values: Values) => {
    ...
    try {
      await studentApi.update(Number(id), {
        ...
        guardian_id: values.guardian_id ? Number(values.guardian_id) : undefined,
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="guardian_id" type="number" {...register("guardian_id")} />
            </div>
            <div className="space-y-1.5">
